...
<script lang="ts">
    ...
    const title = "Liste des tâches à effectuer";

    export let todos: Todo[];

    const processNewResult = async (res: Response, form: HTMLFormElement) => {
...
<div class="todos">
    ...
    <form
        ...
        method="post"
        use:enhance={{
            result: processNewResult,
        }}
    >
        <input
            type="text"
            name="text"
            aria-label="Ajouter une tâches à effectuer"
            placeholder="+ entrez une tâches à ajouter"
        />
    </form>
